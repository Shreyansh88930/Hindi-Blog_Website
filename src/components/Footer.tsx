...
const Footer: React.FC = () => (
  <footer className="w-full py-6 sm:py-8 px-4 sm:px-6 md:px-8 text-center bg-gradient-to-r from-rose-100 via-white to-rose-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 border-t border-gray-200 dark:border-gray-700 mt-16 shadow-inner">
    <div className="flex flex-col items-center space-y-2 sm:space-y-3">
      <span className="text-base sm:text-lg font-semibold text-rose-700 dark:text-rose-300 font-devanagari tracking-wide">
        PL Foundation ब्लॉग
      </span>
      <span className="text-sm sm:text-base text-gray-600 dark:text-gray-400 font-devanagari">
